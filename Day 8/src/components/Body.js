// 1. This session Completely focusses on learning class based components.
// main thing in body+ profileclass 
...
useEffect(()=>{
  ...
  return()=>{
    //use to didunmout in funvctional components...
    // Excecutes when we close page or switch to another page..
