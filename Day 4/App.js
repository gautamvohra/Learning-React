// 1.Making UI that adapts acc to area in which it gets renderd is called Config Drivven UI.
// 2.This Day was majorly focused on using learn using props...
import React from "react";
import ReactDOM from "react-dom/client";

const title = (
  <h2 title="title" key="h2">
    Food Villa
  </h2>
);
...
const burgerKing={
  name:"Burger King",
  image:"https://logos-world.net/wp-content/uploads/2020/04/Burger-King-Logo-1969-1994.png",
  cusines:["Burgers","American"],
  rating:"4.2"
}

const RestrauntCard=({name,cuisines,cloudinaryImageId,costForTwoString})=>{
  // const {name,cuisines,cloudinaryImageId,costForTwoString}=restaurant.data;
    return(
        <div className="card-main">
        <div className="card">
        <img src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/" +
          cloudinaryImageId} className="card-img"/>
